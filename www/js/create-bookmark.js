window.addEventListener('load', () => {
    ...
    document.querySelector('#placeAddBtn').addEventListener('click', () => {
        ...
        place_name_input.name = `bookmark_content[${placeCount}][${document.getElementById('place-name').id}]`
        place_name_input.type="hidden"
        place_name_input.value = place_name
        const place_address_input = document.createElement('input')
        place_address_input.name = `bookmark_content[${placeCount}][${document.getElementById('place-address').id}]`
        ...
        place_comment_input.name = `bookmark_content[${placeCount}][${document.getElementById('place-comment').id}]`
        place_comment_input.type="hidden"
        place_comment_input.value = place_comment
        const expenses_input = document.createElement('input')
        expenses_input.name = `bookmark_content[${placeCount}][${document.getElementById('expenses').id}]`
